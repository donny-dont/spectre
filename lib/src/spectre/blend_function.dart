...
class BlendFunction {
  ...
  static const String AddName = 'BlendFunction.Add';
  ...
  static const String ReverseSubtractName = 'BlendFunction.ReverseSubtract';
  /// The result is the destination subtracted from the source.
  ///
  ///     Result = (Source Color * Source Blend) − (Destination Color * Destination Blend)
  static const int Subtract = 0;
  /// String representation of [Subtract].
  static const String SubtractName = 'BlendFunction.Subtract';

  /// Deserialize the [BlendFunction].
  ...
  /// Gets a map containing a name value mapping of the [BlendFunction] enumerations.
