...
int verifyViewport(MockWebGLRenderingContext gl, Viewport viewport, Viewport viewportLast, [bool copyState = true]) {
...
void testViewportTransitions() {
  ...
  Viewport viewportLast = new Viewport('ViewportLast', graphicsDevice);
  copyViewport(viewport, viewportLast);
